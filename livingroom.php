...
<!DOCTYPE html>
    <html lang="en">
        <head>
        <title>Shop By Living Room</title>
    ...
    <i class='bx bxs-heart'></i>
       ...
       <div class="product-section">
            <h2> Living-Room Dining Table Sets</h2><br><br>

            <div class="product-grid">
            <?php

            $sql = "SELECT * FROM productdetails WHERE category = 'Living Room'";
...
document.addEventListener("DOMContentLoaded", function () {
  // Only apply to icons with .like-toggle
  document.querySelectorAll(".like-toggle").forEach(function (btn) {
...
unction likeProduct(id, name, image) {

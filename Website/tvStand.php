        ...
        <div class="top-navbar">
            ...
            <div class="navbar">
                ...
                <div class="header-icon">
                    ...
                    <a href="heart.php"><i class='bx bxs-heart'></i></a> 
...
<?php endif; ?>
       ...
       <div class="product-section">
        <h2> Luxury Tv Stands</h2><br><br>

   <div class="product-grid">
      <?php

        $sql = "SELECT * FROM productdetails WHERE category = 'Tv stand'";
